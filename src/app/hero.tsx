...
export default function Hero() {
  return (
    <>
      {/* HERO SECTION */}
      <main id="hero" className="bg-white rounded-lg lg:w-11/12 lg:mx-auto border-0 lg:border-2 border-red-900 shadow-lg animate-slideDown">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
            ...
            <div>
              <h1 className="py-4 lg:py-0 text-5xl lg:text-6xl font-bold tracking-tight text-red-900 font-serif">
                Coffee Drinks<br /> Deli Classics <br />
                & Pizza 
              </h1>
...
>
  Directions
            ...
            {/* RIGHT IMAGE */}
            {/* <div className="inset-0 rounded-xl bg-[#f4eee7]/40 mix-blend-multiply shadow-lg">
              <img
                src="/hero-image.png"
                alt="Coffee and deli food at Redbrick"
                className="rounded-xl shadow-lg object-cover w-full h-105"
              />
            </div> */}
  ...
  <img
    ...
    className="rounded-2xl shadow-xl w-full object-cover h-105"
  />
